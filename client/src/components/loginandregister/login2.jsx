        ...
        <div className='bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5'>
            <div className='md:w-1/2 px-16'>
                ...
                <form action="" onSubmit={this.handleSubmit} className='flex flex-col gap-4'>
                    <input className='p-2 mt-8 rounded-xl border' type="email" name='email' onChange={(e) => this.setState({ email: e.target.value})} placeholder='Email' />
                    <div className='relative'>
                        <input className='p-2 rounded-xl border w-full' type="password" name='password'  onChange={(e) => this.setState({ password: e.target.value})} placeholder='Password'/>
