        ...
        <div className='bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5'>
            <div className='md:w-1/2 px-16'>
                ...
                <form action="" onSubmit={handleSubmit} className='flex flex-col gap-4'>
                    <input className='p-2 mt-8 rounded-xl border' type="email" ref={userRef} onChange={(e) => setUser(e.target.value)} value={user} name='email' placeholder='Email' />
                    <div className='relative'>
                        <input className='p-2 rounded-xl border w-full' type="password" onChange={(e) => setPwd(e.target.value)}   value={pwd} name='password' placeholder='Password'/>
