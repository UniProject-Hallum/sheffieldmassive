    ...
    <div className="container-mx-auto p-7 space-x-5 flex item-center justify-center ">
      <div class=" p-2 bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5 bg-white-500">
        ...
        <div class="text-center px-3 pb-6 pt-2">
          <h3 class="text-gray-900 font-bold text-2xl tracking-tight mb-2 font-sans">
            Steven Cook
          </h3>
          ...
          <p class="mt-2 font-sans font-light text-black">
            I am a professional handyman with 12+ years experience, based in
            North-West London. I specialise in wooden flooring and plumbing.
          </p>
        </div>
