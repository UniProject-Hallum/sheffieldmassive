            ...
            <div className='md:w-1/2 px-16'>
                ...
                <div  className='flex flex-col gap-4'>
                    ...
                    <div className='relative'>
                        <input onChange={e => setPasswordValue(e.target.value)} className='p-2 rounded-xl border w-full' type={passwordShown ? "text" : "password"} name='password' placeholder='Password'/>
                        <button onClick={togglePassword}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey"  className='bi bi-eye absolute top-1/2 right-3 -translate-y-1/2' viewBox="0 0 16 16">
