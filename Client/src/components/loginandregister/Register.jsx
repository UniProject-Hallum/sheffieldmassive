      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5">
        ...
        <div className="md:w-1/2 px-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex">
              <div className="flex items-center mr-4">
                <input
                  required
                  onChange={(e) => setRoleValue("customer")}
                  id="inline-radio1"
                  type="radio"
                  value=""
                ...
                <label
                  ...
                  className="ml-2 text-sm font-medium text-[#606060] dark:text-gray-300"
                >
                  Customer
                </label>
              </div>
              <div className="flex items-center mr-4">
                <input
                  required
                  onChange={(e) => setRoleValue("handyman")}
                  id="inline-radio2"
                  type="radio"
                  value=""
                  name="inline-radio-group"
                ...
                <div>
                  ...
                  <div className="flex mt-5 mb-3">
                    <div className="flex items-center mr-4">
                      <input
                        required
                        onChange={(e) => setGenderProfileValue(man)}
                        id="inline-radio3"
                        type="radio"
                        value=""
                    ...
                    <div className="flex items-center mr-4">
                      <input
                        required
                        onChange={(e) => setGenderProfileValue(woman)}
                        id="inline-radio4"
                        type="radio"
                        value=""
                        name="inline-radio-group2"
            ...
            {!emailValue || !passwordValue || !usernameValue || !roleValue ? (
              <button
                disabled
                className="bg-[#606060] rounded-xl text-white py-2 "
              >
                Register
              </button>
            ) : (
              <button
                ...
                className="bg-[#fccc35] rounded-xl text-white py-2 hover:bg-[#ca9f16] hover:scale-110"
              >
                Register
              </button>
            )}
          ...
          <div className="mt-7 mb-4 text-xs flex justify-between items-center">
            ...
            <Link to={"/login"}>
              <button className="text-white py-2 bg-[#606060] px-5 border rounded-xl  hover:bg-[#fccc35] hover:scale-110">
                Login
              </button>
            </Link>
          </div>
